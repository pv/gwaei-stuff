...
gboolean gw_util_is_hiragana_str (const char*);
gboolean gw_util_is_util_kanji_str (const char*);
gboolean gw_util_is_katakana_str (const char*);
gboolean gw_util_is_romaji_str (const char*);
gboolean gw_util_is_kanji_ish_str (const char*);
gboolean gw_util_is_kanji_str (const char*);
gboolean gw_util_is_furigana_str (const char*);
gboolean gw_util_is_yojijukugo_str (const const char*);
