...
//!
void w_frontend_initialize (int* argc, char* argv[])
{
...
//!
int w_frontend_start_console (int argc, char* argv[])
{
    //Declarations
    GError *error;
    gboolean resolution;
...
//! @param argv Your array of strings from main
//!
int w_frontend_start_ncurses (int argc, char* argv[])
{
  printf("ncurses\n");
...
gboolean w_frontend_get_color_switch ()
{
