...
//!
gboolean w_console_uninstall_dictinfo (WApplication* app, GError **error)
{
    //Declarations
    LwDictInfo *di;
...
//!
gboolean w_console_install_dictinst (WApplication *app, GError **error)
{
    //Declarations
    LwDictInst *di;
...
gboolean w_console_search (WApplication *app, GError **error)
{
    //Sanity check
