...
void gw_main_update_total_results_label (GwSearchItem*);
char* gw_main_get_text_slice_from_buffer (int, int, int);
const char* gw_main_get_active_dictionary (void);
char* gw_main_buffer_get_text_by_target (GwTargetOutput);

gboolean gw_main_cancel_search (gpointer);
gboolean gw_main_cancel_search_by_searchitem (GwSearchItem*);
gboolean gw_main_cancel_search_by_tab_number (const int);
gboolean gw_main_cancel_search_by_target (GwTargetOutput);
gboolean gw_main_cancel_search_for_current_tab (void);
void gw_main_tab_cancel_all_searches (void);

void gw_main_display_no_results_found_page (GwSearchItem*);
void gw_main_initialize_buffer_by_searchitem (GwSearchItem*);

void gw_main_set_entry_text_by_searchitem (GwSearchItem*);
void gw_main_set_total_results_label_by_searchitem (GwSearchItem*);
void gw_main_set_search_progressbar_by_searchitem (GwSearchItem*);
void gw_main_set_main_window_title_by_searchitem (GwSearchItem*);

void gw_main_grab_focus_by_target (GwTargetOutput);
...
void gw_main_text_select_all_by_target (GwTargetOutput);
...
void gw_main_paste_text (GwTargetOutput);
void gw_main_cut_text (GwTargetOutput);
void gw_main_copy_text (GwTargetOutput);

void gw_main_cycle_dictionaries (gboolean);

void gw_main_text_select_none_by_target (GwTargetOutput);
void gw_main_strncpy_text_from_widget_by_target (char*, GwTargetOutput, int);

gboolean gw_main_has_selection_by_target (GwTargetOutput);

void gw_main_buffer_reload_tagtable_tags (void);

void gw_main_set_dictionary_by_searchitem (GwSearchItem*);
...
void gw_main_handle_error (GError**, gboolean);
